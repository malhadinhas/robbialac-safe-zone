...
async function seedZoneStats() {
    try {
        ...
        const zoneStatsCollection = await (0, database_1.getCollection)('zone_stats');
        ...
        if (existingZoneStatsCount === 0) {
            ...
            logger_1.default.info(`${zoneStatsResult.insertedCount} estatísticas de zona inseridas com sucesso!`);
        }
        else {
        ...
        const categoryStatsCollection = await (0, database_1.getCollection)('category_stats');
        ...
        if (existingCategoryStatsCount === 0) {
            ...
            logger_1.default.info(`${categoryStatsResult.insertedCount} estatísticas de categoria inseridas com sucesso!`);
        }
        else {

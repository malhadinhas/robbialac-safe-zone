...
const database_1 = require("../services/database"); // Função para obter coleções MongoDB nativas
...
const getBasicAnalytics = async (req, res) => {
    ...
    try {
        ...
        const totalVideos = await Video_1.default.countDocuments(); // Usando Mongoose
...
const getLoginStats = async (req, res) => {
    ...
    try {
        ...
        const loginEventsCollection = await (0, database_1.getCollection)('loginEvents');
...
const getUploadStats = async (req, res) => {
    ...
    try {
        ...
        const uploadLogsCollection = await (0, database_1.getCollection)('uploadLogs');
...
const getErrorLogs = async (req, res) => {
    ...
    try {
        ...
        const errorLogsCollection = await (0, database_1.getCollection)('errorLogs');

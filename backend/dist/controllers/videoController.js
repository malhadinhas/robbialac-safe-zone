...
exports.getLastViewedVideosByCategory = exports.incrementVideoViews = exports.deleteVideo = exports.updateVideo = exports.createVideo = exports.getVideoById = exports.getVideos = void 0;
                ...
                try {
                    ...
                    if (updateResult && updateResult.status === 'ready' && uploadedFileSize) {
                        try {
                            ...
                            await uploadLogsCollection.insertOne(newUploadLog);

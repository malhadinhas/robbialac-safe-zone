...
const getUserRanking = async (req, res) => {
    try {
        ...
        const usersCollection = await (0, database_1.getCollection)('users');
...
const getLeaderboard = async (req, res) => {
    try {
        ...
        logger_1.default.info('Leaderboard recuperado com sucesso', { count: rankedLeaderboard.length });
        res.json(rankedLeaderboard);
    }
    catch (error) {
        logger_1.default.error('Erro ao recuperar leaderboard', { error });

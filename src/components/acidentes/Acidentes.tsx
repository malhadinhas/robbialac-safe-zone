...
import { getAccidents, deleteAccident } from '@/services/accidentService';
           ...
           <DialogContent>
             ...
             <div className="space-y-4">
               ...
               <div className="mt-6 flex justify-end gap-4">
                 ...
                 <Button onClick={() => { toast.info('Funcionalidade de adicionar pendente.'); }} className="bg-robbialac hover:bg-robbialac-dark text-white">
                   Salvar
                 </Button>
               </div>
             </div>

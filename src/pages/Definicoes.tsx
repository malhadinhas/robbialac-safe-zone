...
export default function Definicoes() {
  ...
  // Verifica se o usuário tem permissão para acessar a aba de quase acidentes
    ...
    <Layout>
      <div className="container py-6 space-y-6">
        ...
        <Tabs defaultValue="interface" className="space-y-4">
          <TabsList className={`grid w-full ${isAdminApp ? 'grid-cols-7' : hasIncidentPermission ? 'grid-cols-2' : 'grid-cols-1'}`}>
          ...
          {hasIncidentPermission && (
            <TabsContent value="incidents">
              <Card>
                <CardHeader>
                  <CardTitle>{t('near_miss_settings')}</CardTitle>
                  <CardDescription>{t('near_miss_settings_desc')}</CardDescription>
                </CardHeader>

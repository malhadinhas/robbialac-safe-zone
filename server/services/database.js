    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    uri = database_1.MongoDBConfig.uri;
                ...
                case 3:
                    ...
                    console.error('Detalhes do erro:', error_1);
                    isConnected = false;
                    connectionError = error_1 instanceof Error ? error_1.message : "Erro desconhecido";
                    throw error_1;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('Erro ao desconectar do MongoDB:', error_2);
                    throw error_2;
                case 4:
                    isConnected = false;
                    connectionError = null;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_3 = _a.sent();
                    console.error("Erro durante a reconexão:", error_3);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [2 /*return*/, mongoose_1.default.connection.collection(collectionName)];
            }
        });
    });
}
...
process.on('SIGINT', function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, disconnectFromDatabase()];
            case 1:
                _a.sent();
                process.exit(0);
                return [2 /*return*/];
